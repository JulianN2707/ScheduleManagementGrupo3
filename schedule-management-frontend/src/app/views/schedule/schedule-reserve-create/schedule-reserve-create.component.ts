...
import { NmodalService } from './shared/modals/nmodal/nmodal.service';
...
export class ScheduleReserveCreateComponent {
  ...
  constructor(
    ...
    private modalService:NmodalService
  ...
  actualizarValorInput(nuevoValor: boolean) {
    ...
    console.log(this.check+"valor actualizado desde el padre")
 ...
 setValuesDTOFinal(){
  ...
  //console.log(this.formFinalEventSchedule.eventToScheduleList+"ver dato")
  this.formFinalEventSchedule.eventToScheduleList = this.eventToScheduleList;
  //console.log(this.formFinalEventSchedule.eventToScheduleList+"dato seteado")

  //aqui hacer la suscripcion para consultar el servicio rest
  //console.log(this.formFinalEventSchedule.eventToScheduleList.forEach((element)=>console.log(element))+"informacion final enviada")
